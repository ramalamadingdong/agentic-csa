"""PhotonVision documentation plugin implementation."""
...
@dataclass
class IndexPage:
    """A page in the PhotonVision index."""
...
class Plugin(PluginBase):
    """
    PhotonVision documentation plugin.
    
    Provides access to PhotonVision documentation for vision processing,
    AprilTag detection, camera calibration, and PhotonLib integration.
    """
    ...
    def description(self) -> str:
        return "PhotonVision documentation for vision processing, AprilTag detection, and PhotonLib"
    
    @property
    def supported_versions(self) -> list[str]:
        return ["latest", "2025", "2024"]
    ...
    async def initialize(self, config: PluginConfig) -> None:
        ...
        logger.info(f"PhotonVision plugin initialized with {len(self._pages)} pages")
    ...
    async def search(
        ...
        """Search PhotonVision documentation."""
