"""YAMS (Yet Another Mechanism System) documentation plugin."""
...
class Plugin(PluginBase):
    """YAMS documentation plugin for FRC mechanism control (arms, elevators, shooters)."""
    ...
    def description(self) -> str:
        return "YAMS (Yet Another Mechanism System) documentation for FRC mechanism control"
    ...
    async def initialize(self, config: PluginConfig) -> None:
        ...
        logger.info(f"YAMS plugin initialized with {len(self._pages)} pages")
    ...
    async def fetch_page(self, url: str) -> Optional[PageContent]:
        ...
        try:
            ...
            title = self._html_cleaner.extract_title(html) or "YAMS Documentation"
            return PageContent(
                url=url,
                title=title,
                content=content,
