"""Redux Robotics documentation plugin implementation."""
...
class Plugin(PluginBase):
    ...
    Provides access to Redux Robotics documentation for Canandcoder,
    Canandgyro, and other Redux hardware and software.
    """
    ...
    def description(self) -> str:
        return "Redux Robotics documentation for Canandcoder, Canandgyro, and related hardware"
    ...
    def base_urls(self) -> list[str]:
        return [
            ...
            "https://reduxrobotics.com/docs",
            "http://docs.reduxrobotics.com"
        ]
    ...
    async def initialize(self, config: PluginConfig) -> None:
        ...
        logger.info(f"Redux plugin initialized with {len(self._pages)} pages")
    ...
    async def fetch_page(self, url: str) -> Optional[PageContent]:
        """Fetch and clean a Redux documentation page."""
        ...
        try:
            ...
            title = self._html_cleaner.extract_title(html) or "Redux Robotics Documentation"
