"""YAGSL (Yet Another Generic Swerve Library) documentation plugin."""
...
class Plugin(PluginBase):
    """YAGSL documentation plugin for swerve drive configuration and usage."""
    ...
    def description(self) -> str:
        return "YAGSL (Yet Another Generic Swerve Library) documentation for FRC swerve drive"
    ...
    async def initialize(self, config: PluginConfig) -> None:
        ...
        logger.info(f"YAGSL plugin initialized with {len(self._pages)} pages")
    ...
    async def fetch_page(self, url: str) -> Optional[PageContent]:
        ...
        try:
            ...
            title = self._html_cleaner.extract_title(html) or "YAGSL Documentation"
            return PageContent(
                url=url,
                title=title,
                content=content,
